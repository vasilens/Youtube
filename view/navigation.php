...
<nav>
    ...
    <li><a href="/user/subscriptions/<?= $user_id ?>"><img src="styles/images/subscriptionsLogo.png" class="navPics">Subscriptions</a></li>
    <hr>
    ...
    <li><a href="/myplaylists/<?= $user_id ?>"><img src="styles/images/playlistLogo.png" class="navPics">Playlists</a></li>
    </ul>
</nav>
